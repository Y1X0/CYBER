...
**Current: 1699 Python tests + 15 web tests passing** (+1162, 14 skipped — RLS assertions that need
an RLS-enforced app session), 28 work packages delivered, CI green.
