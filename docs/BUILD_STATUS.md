...
**Current: 1663 Python tests + 7 web tests passing** (+1118, 14 skipped — RLS assertions that need
an RLS-enforced app session), 27 work packages delivered, CI green.
